...
public class StorageManager {
	...
	public void deleteFilesWithPrefix(String bucketName, String prefix) throws StorageException {
	...
	public void uploadMultipartForZip(String bucketName, String objectKey, String localFilePath)
		...
		try {
			...
			// TODO: add log
			throw new StorageException("The call was transmitted successfully, but OSU couldn't process", e);
		} catch (SdkClientException e) {
			// OSU couldn't be contacted for a response, or the client
			// couldn't parse the response from OSU.
			// TODO: add log
			throw new StorageException("OSU couldn't be contacted for a response, or the client", e);
		}
	}
