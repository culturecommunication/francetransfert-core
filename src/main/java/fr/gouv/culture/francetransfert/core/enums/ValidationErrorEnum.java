...
public enum ValidationErrorEnum {
	...
	FT02("typePli", "ERR_FT01_002", "La valeur fournie pour le champ typePli doit appartenir à la liste de valeur « Liste des types de pli »"),
	FT04("courrielExpediteur", "ERR_FT01_004", "Le domaine de messagerie du courriel expéditeur doit être celui d’un agent de l’Etat "),
	FT05("courrielExpediteur", "ERR_FT01_005", "Le courriel expéditeur est obligatoire"),
	FT06("courrielExpediteur", "ERR_FT01_006", "Le courriel expéditeur doit respecter le format d’un courriel"),
	FT07("destinataires", "ERR_FT01_007", "Une liste de destinataires est obligatoire si le type de Pli est « courriel »"),
	FT08("destinataires.courrielDestinataire", "ERR_FT01_008", "Si une liste de destinataires est fournie alors au moins un destinataire doit être renseigné"),
	FT09("destinataires.courrielDestinataire", "ERR_FT01_009", "Le courriel destinataire doit respecter le format d’un courriel"),
	FT010("preferences.dateValidite", "ERR_FT01_010", "La date de fin de validité du pli doit être comprise entre J+1 et J+90 jours"),
	FT011("preferences.dateValidite", "ERR_FT01_011", "La date de fin de validité doit respecter le format d’une date"),	
	FT012("preferences.motDePasse", "ERR_FT01_012", "Le mot de passe doit respecter les critères de robustesse et caractères autorisés : 12 caractères minimum - 20 caractères maximum - Au moins 3 lettres minuscules (a-z non accentué) - Au moins 3 lettres majuscules (A-Z non accentué) - Au moins 3 chiffres - Au moins 3 caractères spéciaux (!@#$%^&*()_-:+) - aucun caractère spécial non supporté\r\n"),
	FT014("preferences.langueCourriel", "ERR_FT01_014", "La valeur fournie pour le champ langueCourriel doit appartenir à la liste de valeur « Liste des langues de courriel »"),
	FT016("preferences.protectionArchive", "ERR_FT01_016", "Le champ protectionArchive doit respecter le format d’un booléen"),
	FT018("fichiers", "ERR_FT01_018", "Au moins un fichier doit être fourni"),
	FT019("fichiers.nomFichier", "ERR_FT01_019", "Le nom de fichier est obligatoire"),
	FT020("fichiers.tailleFichier", "ERR_FT01_020", "La taille de fichier est obligatoire"),
