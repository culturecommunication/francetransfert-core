...
public enum ValidationErrorEnum {
	...
	FT06("courrielExpediteur", "ERR_FTXX_003", "Le courriel expéditeur / utilisateur doit respecter le format d’un courriel"),
	...
	FT601("idPli", "ERR_FT06_001", "Pour autoriser la fourniture de l’URL de téléchargement du pli, le statut du pli doit être 032-PAT ou 040-ECT"),
