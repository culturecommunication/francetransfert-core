...
public enum ValidationErrorEnum {
	...
	FT04("courrielExpediteur", "ERR_FTXX_001", "Le domaine de messagerie du courriel expéditeur doit être celui d’un agent de l’Etat"),
	...
	FT205("idPli", "ERR_FTXX_004", "Le courriel expéditeur et l’identifiant de pli indiqués dans la requête doivent correspondre à un pli connu de France transfert"),	
