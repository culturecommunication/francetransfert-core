...
public enum RedisQueueEnum {
	MAIL_QUEUE("email-notification-queue"),MAIL_NEW_RECIPIENT_QUEUE("email-new-recipient-notification-queue"), ZIP_QUEUE("zip-worker-queue"),
	...
	NEW_RECIPIENT("new-recipient"), NEW_ID_RECIPIENT("new-id-recipient"), DELETE_RECIPIENT("delete-recipient");
